...
if __name__ == '__main__':
    ...
    args.add_argument('--criterion', '-c', type=str, default='squared_error')
    args.add_argument('--max_depth', '-md', type=int, default=None)
    args.add_argument('--n_estimators', '-e', type=int, default=100)
